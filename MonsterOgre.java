...
public class MonsterOgre extends Enemy {
    ...
    /**
     * Creates attacks and defenses for the ogre
     */
    private void addAttacks() {
        Defense[] attack1Defenses = {
                ...
                new Defense("block with the shield", 10,
                        "You tried to block the hit, but the club is too heavy. Damage: 10")
        };
        ...
        Defense[] attack2Defenses = {
                ...
                new Defense("duck down", 15,
                        "You tried to duck down, but you weren't fast enough. Ogre's punch sends you flying across the room. Damage: 15"),
                new Defense("block with the shield", 0,
                        "Even though the hit was strong, you successfully blocked the hit. Damage: 0")
        };
