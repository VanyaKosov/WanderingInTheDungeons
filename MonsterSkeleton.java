...
public class MonsterSkeleton extends Enemy {
    ...
    private void addAttacks() {
        Defense[] attack1Defenses = {
                ...
                new Defense("block with the shield", 0, "You succesfully blocked the arrow. Damage: 0")
        };
        ...
        Defense[] attack2Defenses = {
                ...
                new Defense("duck down", 0, "The arrow cut a few hairs from your head, but otherwise you are intact. Damage: 0"),
                new Defense("block with the shield", 10, "The arrow was enchanted because it penetrated through you shield like it wasn't even there and hit you. Damage: 10")
        };
        Attack attack2 = new Attack("The skeleton aims at you with it's bow. The arrow glows suspiciously", attack2Defenses);
        attacks.add(attack2);

        Defense[] attack3Defenses = {
                new Defense("jump", 10, "The bone pierced your belly. Damage: 10"),
                new Defense("duck down", 5, "You almost evaded the hit but the bone still left a deep cut in your shoulder. Damage: 5"),
