...
public class MonsterGoblin extends Enemy {
    ...
    /**
     * Creates attacks and defenses for the goblin
     */
    private void addAttacks() {
        Defense[] attack1Defenses = {
                ...
                new Defense("block with the shield", 3,
                        "The goblin is too fast. He left a deep cut in one of your legs. Damage: 3")
        };
        ...
        Defense[] attack2Defenses = {
                ...
                new Defense("block with the shield", 3,
                        "You weren't fast enough. Goblin cut one of your arms. Damage: 3")
        };
        ...
        Defense[] attack3Defenses = {
                ...
                new Defense("block with the shield", 0,
                        "You successfully blocked the dagger with the shield. Damage: 0")
        };
